    ...
    <div class="container-xxl py-5">
      ...
      <form action="questioninsert" method="post">
        <div class="card-body col-12 div-center pl-5 pr-5">
          <div class="row g-5">
            <h3 style="vertical-align: bottom" class="px-2">
              <input type="text" size="89%" placeholder="문의 제목을 입력해주세요." id="questionTitle" name="questionTitle" required="required" />
            </h3>
        ...
        <div class="btn-center mt-2">
          ...
          &nbsp;&nbsp;
          <button type="submit" class="btn btn-primary border-0 rounded-pill px-4 py-3">작성</button>
        </div>
        <!-- 버튼 END -->
      </form>
    </div>
