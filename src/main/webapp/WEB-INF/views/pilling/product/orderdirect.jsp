      ...
      <div class="container py-5">
          ...
          <div class="card-body mb-3">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                  <tr class="item-row">
                    <td width="100"><img src="${cart.filepath }" alt="제품 이미지" width="80px" height="80px" /></td>
        ...
        <div class="mb-4">
          ...
          <table class="table table-bordered" id="dataTable">
            <tr>
              ...
              <td class="td-rightnone"><a id="userLastname">${user.userLastname }</a><a id="userFirstname">${user.userFirstname }</a></td>
            </tr>
            <tr>
              <td style="background-color: #f5f6f6">주소</td>
              <td class="td-rightnone"><a id="userAddr">${user.userAddr }</a>&nbsp;<a id="userAddrdetail">${user.userAddrdetail }</a></td>
            </tr>
            <tr>
        ...
        <form id="shippingForm" action="makepaymentdirect" method="post">
            ...
            <table class="table table-bordered" id="dataTable">
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    id="shippingRecipientln"
                    name="shippingRecipientln"
                    class="form-control"
                    placeholder="성을 입력해주세요."
                    required
                  /><span id="lnameConfirmMsg"></span>
                </td>
              </tr>
              <tr>
                <!-- 이름 INPUT -->
                ...
                <td>
                  <input
                    type="text"
                    id="shippingRecipientfn"
                    name="shippingRecipientfn"
                    class="form-control"
                    placeholder="이름을 입력해주세요."
                    required
                  />
                  <span id="fnameConfirmMsg"></span>
                </td>
              </tr>
              <tr>
                <td style="background-color: #f5f6f6">주소</td>
                <td>
                  ...
                  <div style="margin-bottom: 20px">
                    ...
                    <input type="text" class="form-control" id="shippingAddrdetail" name="shippingAddrdetail" placeholder="상세주소" required />
                  </div>
          ...
          <div class="mb-4">
            ...
            &nbsp;&nbsp; <input type="radio" id="addrEqual" name="addrRadio" value="Y" onClick="copyShippingaddr()" />&nbsp;네&nbsp;&nbsp;&nbsp;
            <input type="radio" id="saddrNotEqual" name="addrRadio" value="N" checked="checked" />&nbsp;&nbsp;아니오
          </div>
          <!-- 라디오버튼 END -->
          ...
          <div class="mb-4">
            <h5>배송 요청사항</h5>
            <input type="text" id="shippingRequest" name="shippingRequest" size="100%" placeholder="요청사항이 있으면 입력해주세요. (60자 이내)" />
          </div>
          <!-- 배송 요청사항 END -->
          ...
          <div class="mb-5">
            ...
            <table class="table table-bordered" id="dataTable">
              ...
              <tr>
                ...
                <td>
                  <a id="userPoint">${user.userPoint }원</a
                  ><input
                    type="text"
                    id="pointSelect"
              ...
              <tr>
                ...
                <td><input type="radio" name="payment" value="kakaopay" checked="checked" />&nbsp;&nbsp;카카오페이</td>
              </tr>
            </table>
          </div>
          ...
          <input type="hidden" id="orderTotalprice" name="orderTotalprice" /> <input type="hidden" id="orderCard" name="orderCard" />
        ...
        <!-- 결제버튼 -->
        <div class="center">
          <button type="button" class="px-5 py-3 btn btn-primary border-2 rounded-pill animated slideInDown mb-4 ms-4" onclick="shippingFormCheck()">
            결제하기
          </button>
        </div>
        <!-- 결제버튼 END -->
