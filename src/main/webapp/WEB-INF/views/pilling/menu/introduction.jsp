            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid w-100 mb-3 wow fadeIn rounded" data-wow-delay="0.1s" src="resources/pilling/img/introduction/introduction-1.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn " data-wow-delay="0.3s" src="resources/pilling/img/introduction/introduction-2.jpg" alt="">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                        ...
                        <h1 class="display-6">이 약 한번 먹어볼테야?</h1>
                    </div>
