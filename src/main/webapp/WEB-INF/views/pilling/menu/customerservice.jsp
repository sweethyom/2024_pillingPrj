...
<body>
	<section>
      <div class="container-fluid customerservice-header py-5">
        <div class="container text-center py-4">
          <h1 class="display-2 text-white register-form-margin animated slideInDown">고객센터</h1>
	...
	<div class="container mt-3">
		<ul class="pagination justify-content-center">
			<li class="page-item"><a class="page-link" href="#">Previous</a></li> <!-- 첫페이지에선 없음/시작인덱스 -10 -->
			...
			<li class="page-item"><a class="page-link" href="#">Next</a></li><!-- 마지막인덱스 +10 /마지막 인덱스에서는 없음 -->
		</ul>	
	</div>
</div>
	<div>
