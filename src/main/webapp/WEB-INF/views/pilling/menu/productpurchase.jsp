									...
									<div class="mb-3">
										...
										<ul class="filterList">
											<c:forEach var="keyword" items="${checkboxList }">
												<c:if
													test="${keyword.keywordId == 20 or keyword.keywordId == 21}">
													<li class="filterItem">
														<div class="filterName">
															<input type="checkbox" name="effectId"
																id="keyword${keyword.keywordId}"
																value="${keyword.keywordId}" /> <label
																for="keyword${keyword.keywordId}" class="keywordName">&nbsp;${keyword.keywordName}</label>
														</div>
													</li>
												</c:if>
											</c:forEach>
							...
							<div id="productsContainer"
								...
								<c:forEach var="product" items="${productlist }">
									<div class="col-md-6 col-lg-6 col-xl-4">
										<a
											href="${pageContext.request.contextPath}/productdetailpage?productId=${product.productId}">
									...
									<ul class="pagination justify-content-center">
										...
										<c:forEach begin="1" end="${totalPages}" var="i">
											<li class="page-item ${pageNum == i ? 'active' : ''}"><a
												class="page-link"
												href="?pageNum=${i}${searchInput != null ? '&searchInput=' + searchInput : ''}"
